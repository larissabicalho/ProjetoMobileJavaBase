...
public class PageBase {
    ...
    protected void doubleTapPress(By gestures){
        ...
        Coordinates points = element.getCoordinates();
        doubleTap(points.onPage().getX(), points.onPage().getY());
    ...
    protected void sendKeysBoard(String texto) {
